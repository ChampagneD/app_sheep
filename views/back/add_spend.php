	...
	<div class="txtright">
		...
		<?php foreach ($users as $user): ?>
			...
			<p style="margin-top: 2%">
				...
				<input style="margin-right: 2%" type="checkbox" name="check_list[]" value="<?php echo intval($user['user_id']) ?>"/>
				<input type="number" min="0" name="user_<?php echo intval($user['user_id']); ?>"/>
